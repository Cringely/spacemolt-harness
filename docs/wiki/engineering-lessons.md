...
Source: PM live capture, 2026-09-20 (not verifiable from the repo); PR #114 and PR #115 (M-57, closing #534 and #458); tracker issues #1114 (no autonomous fleet-rescue path), #1115 (refuel give-up latch never clears), #1116 (buy-guard refusal hands back a resubmittable template).
